 ...
 * model on any serving route. Missing provider or model identity never
 * matches: guidance fails toward silence, not noise.
 */
export function matchesBinding(
  ...
  if (!binding.models.includes(model)) return false;
